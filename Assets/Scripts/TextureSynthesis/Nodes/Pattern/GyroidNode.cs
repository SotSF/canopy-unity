...
[Node(false, "Pattern/Gyroid")]
public class GyroidNode : TickingNode
{
    public const string ID = "gyroidNode";
    public override string GetID { get { return ID; } }
    public override string Title { get { return "Gyroid"; } }
    ...
    [ValueConnectionKnob("xScale", Direction.In, "Float")]
    public ValueConnectionKnob xScaleKnob;

    [ValueConnectionKnob("yScale", Direction.In, "Float")]
    public ValueConnectionKnob yScaleKnob;
