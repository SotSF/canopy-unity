                ...
                if (dataframe.fin) {
                    ...
                    switch (opcode)
                    {
                        case WebSocketOpCode.Text:
                            ...
                            wsEvent = new WebSocketEvent(this, WebSocketEventType.Text, data);
                            server.events.Enqueue(wsEvent);
                            break;
                        case WebSocketOpCode.Close:
                            ...
                            wsEvent = new WebSocketEvent(this, WebSocketEventType.Close, null);
                            server.events.Enqueue(wsEvent);
                            // Jump out of the loop.
                            return;
                        case WebSocketOpCode.Binary:
                            wsEvent = new WebSocketEvent(this, WebSocketEventType.Binary, null, WebSocketProtocol.DecodeBytes(dataframe));
                            server.events.Enqueue(wsEvent);
                            break;
                    }
                } else {
